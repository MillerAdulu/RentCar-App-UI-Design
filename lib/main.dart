...
import 'package:rent_car/bloc/state_bloc.dart';
import 'package:rent_car/bloc/state_provider.dart';
        ...
        RichText(
          text: TextSpan(
            ...
            children: [
              ...
              TextSpan(text:"/n"),
              TextSpan(text: currentCar.carName, style: TextStyle(fontWeight: FontWeight.w700)),
            ]
          )
        ),
        SizedBox(height: 10),
  ...
  Widget build(BuildContext context) {
    return Positioned(
      ...
      child: GestureDetector(
        onTap:(){
          controller.isCompleted ? controller.reverse() : forwardAnimation();
        },
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          isMap ? Text(innerMap.keys.elementsAt(0), 
